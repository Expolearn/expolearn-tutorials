$(document).ready(function () {
  ...
  var developerDetails =
    dev.getPersonDetails(
      ...
      "+27 73953553",
      " Developer"
    ) + dev.getDevskills(["java", "C", "C++", "Python"], 5);

  developer.innerHTML = developerDetails;
  ...
  var marketerDetails =
    ...
    mark.getmarkskills(
      ["Advertising", "Sales", "Digital marketer", "Social media marketer"],
      "9 years"
    );
  marketer.innerHTML = marketerDetails;
  ...
  var studentDetails =
    ...
    stud.getstudskills(
      ["AI", "HCI", "software engineering", "algorithms"],
      " 2nd year"
    );
  ...
  var businessmanDetails =
    busi.getPersonDetails(
      "ndivhuwo",
      "Ndadza",
      "ndadza@gmail.com",
      " 89th Rd durban",
    ...
    busi.getbusiskills(
      ["House Sales", "Car dealer", "Live Stock", "Industrial"],
      "10 years"
    );

  businessman.innerHTML = businessmanDetails;
});
